---
layout: post
title: "GoRead2 Turns One"
excerpt_separator: <!-- more -->
---
A little over a year ago, after having discovered Claude Code, I decided to resurrect [GoRead](https://github.com/madelynnblue/goread), which was itself a resurrection of Google Reader. On July 26, 2025, I made the [first commit](https://github.com/jeffreyp/goread2/commit/6994fd86f39e585d5fc06bbd3edf3864ace6e816). Here we are, one year and 838 commits later! I can still only count myself as the one paying customer, but I never  intended this to be a money maker--I just wanted to cover the Google App Engine costs. 
...
Happy first birthday and cheers to [GoRead2](https://goreadapp.com)! 🎂🎉